...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        "special-gothic": ["Anta_400Regular"],
        "numeric-data": ["Anta_400Regular"],
        "display-lg": ["Anta_400Regular"],
        "body-md": ["Anta_400Regular"],
        "headline-lg-mobile": ["Anta_400Regular"],
        "headline-md": ["Anta_400Regular"],
        "headline-lg": ["Anta_400Regular"],
        "body-lg": ["Anta_400Regular"],
        "label-md": ["Anta_400Regular"],
      },
      fontSize: {
